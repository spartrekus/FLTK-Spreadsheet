...
void Fl_Table::draw()
{
	...
	//draw_box(FL_THIN_DOWN_FRAME, x(), y(), w(), h(), color());
	...
	if ( damage() & FL_DAMAGE_ALL )
	{
		...
		{ 	//mod by nab to provide a better visual
			//fl_rectf(wix, wiy, row_header_width(), col_header_height(), fl_color());  //was just this
			fl_color(HDRCOLOR);//same as header cols
			fl_draw_box(FL_THIN_UP_BOX, wix, wiy , row_header_width(), col_header_height(), fl_color());
			fl_color(FL_WHITE);
			fl_draw("ALL", wix, wiy, row_header_width(), col_header_height(), (Fl_Align) FL_ALIGN_CENTER);
			//selecting this selects all cells; click on any cell to cancel
		}
